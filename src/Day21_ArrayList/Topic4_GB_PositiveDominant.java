...
public class Topic4_GB_PositiveDominant {
 ...
 */
    ...
    public static boolean isPositiveDominant(int [] MyArray){
        /* I need to find how many unique positive numbers I have.Need to find how many unique negative number I have
        Compare them
        if I have more unique positive number,I ll return true otherwise return to false
         */
       // I need to find how many unique positive numbers I have
        ArrayList<Integer>UniquePositiveNumbers= new ArrayList<>();
        for (int Number : MyArray) {
            if(Number>0){
                if(UniquePositiveNumbers.contains(Number)==false);
             UniquePositiveNumbers.contains();
            }
