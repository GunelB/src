...
public class Homework_34 {
    public static void main(String[] args) {
        // Write a method that takes the day as an integer such as (1 for Monday, 2 for Tuesday, and so on) and it returns a String value indicating "Go To Work" for weekdays and "Go Back to Sleep" weekends.
